...
class FullScreenImageActivity : AppCompatActivity() {
    ...
    private lateinit var scoreDatabase: ScoreDatabaseHelper
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        scoreDatabase = ScoreDatabaseHelper(this)
        btnRecordScore.setOnClickListener { recordScore() }
        btnClearScores.setOnClickListener { clearScores() }
        ...
        val dialog = MaterialAlertDialogBuilder(this, R.style.CustomAlertDialogTheme)
            ...
            .setPositiveButton("Save") { _, _ ->
                ...
                if (userName.isNotEmpty()) {
                    saveScore(userName, correct, total)
                } else {
    ...
    private fun saveScore(userName: String, correct: Int, total: Int) {
