...
import ScoreDatabaseHelper
import ScoreDatabaseHelper4
...
class FullScreenImageActivity3 : AppCompatActivity() {
    ...
    private lateinit var scoreDatabase: ScoreDatabaseHelper4
    private lateinit var btnClearAnswers: Button
    private lateinit var textToSpeech: TextToSpeech

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        setContentView(R.layout.activity_full_screen_image3)
        ...
        overlayView.setOnBoundingBoxClickListener { boundingBox ->
            showLabelInputDialog(boundingBox)
        }

        btnCheckAnswers.setOnClickListener { checkAnswers() }
        scoreDatabase = ScoreDatabaseHelper4(this)
        btnRecordScore.setOnClickListener { recordScore3() }
        btnClearScores.setOnClickListener { clearScores3() }
        btnClearAnswers.setOnClickListener { clearBoundingBoxAnswers() }
    }

    private fun showLabelInputDialog(boundingBox: BoundingBox) {
    ...
    private fun checkAnswers() {
        ...
        askForUserName(correctCount, total)
    }

    private fun askForUserName(correct: Int, total: Int) {
        val editText = EditText(this).apply {
        ...
        val dialog = MaterialAlertDialogBuilder(this, R.style.CustomAlertDialogTheme)
            ...
            .setPositiveButton("Save") { _, _ ->
                ...
                if (userName.isNotEmpty()) {
                    saveScore3(userName, correct, total)
                } else {
    ...
    private fun saveScore3(userName: String, correct: Int, total: Int) {
