...
class ScoreDatabaseHelper3(context: Context) : SQLiteOpenHelper(context, DATABASE_NAME, null, DATABASE_VERSION) {

    companion object {
        private const val DATABASE_NAME = "UserScores2.db"
        private const val DATABASE_VERSION = 1
        private const val TABLE_NAME = "scores2"
